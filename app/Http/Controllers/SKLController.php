...
class SKLController extends Controller
{
    ...
    public function edit()
    {
        ...
        // Ambil daftar brand yang punya pemagang completed & belum punya SKL
        $brands = IR::query()
        ...
        return view('admin.skl_editor', compact('config', 'brands'));
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($request->ajax() || $request->wantsJson() || $request->header('X-Requested-With') === 'XMLHttpRequest') {
            return response()->json(['success' => true, 'message' => '✅ Data SKL berhasil diperbarui!']);
        }

        return redirect()->route('admin.skl.editor')->with('success', '✅ Data SKL berhasil diperbarui! Silakan pilih pemagang dan generate SKL.');
    }
